 ...
 */
	...
	struct fileInfo {
		...
		bool		is_selected;			// whether file is selected (by file manager - initialized to false)
		bool		is_directory;			// whether file is a directory
		bool		is_image;				// whether file is an image supported by Image class
		bool		is_audio;				// whether file is an audio supported by CMPlayer class
	};
	 ...
	 */
	inline bool fileOnMask(char *ext, char (*file_mask)[][MAX_EXT_SIZE]);
