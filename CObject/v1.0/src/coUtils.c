...
static const char *_CO_TRUE_STR  = "true";
static const char *_CO_FALSE_STR = "false";
static const char *_CO_NULL_STR  = "(null)";
static const char *_CO_VERTICAL_STR = "vertical";
static const char *_CO_HORIZONTAL_STR = "horizontal";

inline const char* coUtils_getTrueStr() { return _CO_TRUE_STR; }
inline const char* coUtils_getFalseStr() { return _CO_FALSE_STR; }
inline const char* coUtils_getNullStr() { return _CO_NULL_STR; }
inline const char* coUtils_getVerticalStr() { return _CO_VERTICAL_STR; }
inline const char* coUtils_getHorizontalStr() { return _CO_HORIZONTAL_STR; }
